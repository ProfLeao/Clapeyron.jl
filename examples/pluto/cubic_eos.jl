...
# ╔═╡ 0ffc27ac-df07-4d75-8bf7-af1da6a4ca0a
md"""
...
# ╔═╡ fe2247ad-13c1-4255-8650-0601c85d750e
...
md"Collecting some data from the NIST Chemistry Webbook"
...
manifest_format = "2.0"
project_hash = "29af0dec1bfacd8515d676771e71e0e78107cba7"
...
[[deps.Clapeyron]]
deps = ["BlackBoxOptim", "CSV", "DiffResults", "Downloads", "FillArrays", "ForwardDiff", "JSON3", "LinearAlgebra", "LogExpFunctions", "NLSolvers", "OrderedCollections", "PackedVectorsOfVectors", "PositiveFactorizations", "PrecompileTools", "Preferences", "Roots", "Scratch", "SparseArrays", "StaticArrays", "Tables", "UUIDs"]
git-tree-sha1 = "3b413c2af577ea248e8a163df80d98eb5fb032ce"
